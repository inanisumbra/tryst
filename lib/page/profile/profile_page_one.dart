...
import 'package:polynectr/page/profile/profile_const.dart';
import 'package:polynectr/page/profile/top_bar.dart';
...
class Photo {
  Photo({required this.path, required this.isImage});
      ...
      return Container(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, idx) {
            if (idx < 2) {
              return itemPhoto(photos[idx]);
            } else if (idx == 2) {
              if (photos.length > 2) {
                return itemText("+${photos.length}");
              } else {
                return itemPhoto(photos[idx]);
              }
            } else {
              return itemPhoto(photos[idx - 1]);
            }
          },
        ),
      );
