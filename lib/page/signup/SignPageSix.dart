...
import 'package:polynectr/page/signup/widgets/signup_6_box.dart';
import 'package:polynectr/page/signup/widgets/signup_arrow_button.dart';
import 'package:polynectr/page/signup/widgets/signup_const.dart';

class SignPageSix extends StatefulWidget {
  const SignPageSix({Key? key}) : super(key: key);
...
class _SignPageSixState extends State<SignPageSix>
  ...
  late StreamController<bool> isCreating;
  ...
  void initState() {
    ...
    _controller3 = AnimationController(
        vsync: this, duration: const Duration(microseconds: 0));

    _controller1.forward();

    isCreating = StreamController.broadcast();
  }
