...
import 'package:polynectr/const/_const.dart' hide TEXT_NORMAL_SIZE;

class FeedFivePage extends StatefulWidget {
  const FeedFivePage({Key? key}) : super(key: key);
  ...
  Widget _content2() => Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            const Text("Photo", style: TextStyle(color: textBlack)),
            Expanded(
                child: Container(
