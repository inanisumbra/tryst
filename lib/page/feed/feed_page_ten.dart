...
class FeedPageTen extends StatefulWidget {
  const FeedPageTen({Key? key}) : super(key: key);
...
class _FeedState extends State<FeedPageTen> {
  ...
  Widget _header() => Padding(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            image: const DecorationImage(image: AssetImage(FeedImage.white_back)),
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(colors: [themeYellow, themeGreen]),
        ),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
