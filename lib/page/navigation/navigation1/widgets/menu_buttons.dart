...
import 'package:polynectr/page/navigation/navigation1/widgets/button.dart';

class MenuButtons extends StatelessWidget {
	const MenuButtons({Key? key, required this.onHomePressed, required this.onChatPressed, required this.onFeedPressed, required this.onProfilePressed, required this
			.onSettingsPressed}) : super(key: key);
	...
	List<Widget> _allButtons({int? notifications}) => [
		...
		Padding(
		  ...
		  child: Button.chat(onChatPressed, notification: notifications as int),
		),
		Padding(
